...
@section('content_header')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/admin/errors-management')}}"><i class="fas fa-tachometer-alt"></i> {{__('backend.home')}}</a></li>
    </ol>
@stop
                ...
                <div class="info-box mb-3">
                  <span class="info-box-icon {{isset($err['bg-color'])?$err['bg-color']:"bg-danger"}} elevation-1">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><i class="fas fa-fw fa-link"></i> {{Hayrullah\ErrorsManagement\Models\ErrorsManagement::Type($err['code'])->count()}}</span>
